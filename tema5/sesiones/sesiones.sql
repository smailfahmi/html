...
insert into menu (codigo,linea,codigoPagina) values ('LIN01','Opcion menú 1','PAG01');
insert into menu (codigo,linea,codigoPagina) values ('LIN02','Opcion menú 2','PAG02');
insert into menu (codigo,linea,codigoPagina) values ('LIN03','Opcion menú 3','PAG03');
insert into menu (codigo,linea,codigoPagina) values ('LIN04','Opcion menú 4','PAG04');

insert into opcionMenu (codigoPerfil,codigoMenu) values ('ADM01','LIN01');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('ADM01','LIN02');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('ADM01','LIN03');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('ADM01','LIN04');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('P0001','LIN02');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('P0001','LIN03');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('P0002','LIN02');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('P0002','LIN03');
insert into opcionMenu (codigoPerfil,codigoMenu) values ('P0002','LIN04');
