...
<body>
    ...
    ?>
        <form action="" method="post" name="formulario1" enctype="multipart/form-data">
            <p><label for="">Alfabetico <input type="text" name="Alfabetico" id="Alfabetico" placeholder="Nombre" value=<?
            ...
            <p><label for="">Numerico <input type="number" name="Numerico" id="Numerico" placeholder="Numerico"></label> <?
